...
class NatNetClient:
    ...
    def __unpack_skeleton_description(self, data, major, minor):
        skeleton_desc = SkeletonDescription()
        offset = 0
    ...
    def __unpack_camera_description(self, data, major, minor):
        ...
        camera_desc = CameraDescription(name, position, orientation)
